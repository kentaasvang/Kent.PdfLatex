...
\cvname{Kent Martin} % Your name
\cvjobtitle{Software developer} % Job title/career

\cvdate{01/02/3456} % Date of birth
\cvaddress{Norway} % Short address/location, use \newline if more than 1 line is required
\cvnumberphone{12345678} % Phone number
\cvmail{mail@mail.mail} % Email address
\cvsite{www.google.com}
\cvsiteb{linkedin.com/myname} % Personal website
...
\aboutme{I'm just an awesome person} % To have no About Me section, just remove all the text and leave \aboutme{}
